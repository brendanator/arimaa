...
var or__3630__auto__ = (function (){var G__16209 = n;
return (reagent.impl.template.attr_aliases.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.attr_aliases.cljs$core$IFn$_invoke$arity$1(G__16209) : reagent.impl.template.attr_aliases.call(null,G__16209));
})();
...
var G__16212 = o;
(G__16212[(function (){var G__16213 = k;
return (reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1(G__16213) : reagent.impl.template.cached_prop_name.call(null,G__16213));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__16214){
var vec__16216 = p__16214;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16216,(0),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16216,(1),null);
var pid = (props["id"]);
...
var pname_16219 = (function (){var G__16218 = k;
return (reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1(G__16218) : reagent.impl.template.cached_prop_name.call(null,G__16218));
})();
if(!((pname_16219 === "key"))){
(o[pname_16219] = reagent.impl.template.convert_prop_value(v));
} else {
}
...
var res = (function (){var G__16221 = e;
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__16221) : on_change.call(null,G__16221));
})();
...
var G__16224 = jsprops;
(G__16224["defaultValue"] = value);

(G__16224["value"] = null);

(G__16224["onChange"] = ((function (G__16224,on_change,value){
return (function (p1__16222_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__16222_SHARP_);
});})(G__16224,on_change,value))
);
...
var jsargs = (function (){var G__16230 = argv;
var G__16231 = ((hasprops)?(2):(1));
var G__16232 = ((inprops["level"]) + (1));
return (reagent.impl.template.convert_args.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.convert_args.cljs$core$IFn$_invoke$arity$3(G__16230,G__16231,G__16232) : reagent.impl.template.convert_args.call(null,G__16230,G__16231,G__16232));
})();
var jsprops = reagent.impl.template.convert_props(((hasprops)?props:null),id_class);
if((input_setup == null)){
} else {
var G__16233_16235 = this$;
var G__16234_16236 = jsprops;
(input_setup.cljs$core$IFn$_invoke$arity$2 ? input_setup.cljs$core$IFn$_invoke$arity$2(G__16233_16235,G__16234_16236) : input_setup.call(null,G__16233_16235,G__16234_16236));
}
...
var G__16238 = spec;
(G__16238["componentDidUpdate"] = ((function (G__16238){
return (function (){
var c = this;
...
(G__16238["componentWillUnmount"] = ((function (G__16238){
return (function (){
var c = this;
...
return (function (p1__16239_SHARP_,p2__16240_SHARP_){
var C = this;
return reagent.impl.template.wrapped_should_update(C,p1__16239_SHARP_,p2__16240_SHARP_);
...
var vec__16242 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16242,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16242,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16242,(2),null);
...
var vec__16244 = reagent.impl.template.parse_tag(tag);
var comp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16244,(0),null);
var id_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16244,(1),null);
...
var res = (function (){var G__16246 = withrender;
return (reagent.impl.template.create_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.create_class.cljs$core$IFn$_invoke$arity$1(G__16246) : reagent.impl.template.create_class.call(null,G__16246));
})();
...
var G__16248 = tag;
return (reagent.impl.template.cached_wrapper.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_wrapper.cljs$core$IFn$_invoke$arity$1(G__16248) : reagent.impl.template.cached_wrapper.call(null,G__16248));
} else {
...
var k_16251 = reagent.impl.template.get_key(cljs.core.meta(v));
var k_SINGLEQUOTE__16252 = (((k_16251 == null))?reagent.impl.template.get_key(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(1),null)):k_16251);
if((k_SINGLEQUOTE__16252 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__16252);
}

var G__16250 = jsprops;
return (c.cljs$core$IFn$_invoke$arity$1 ? c.cljs$core$IFn$_invoke$arity$1(G__16250) : c.call(null,G__16250));
});
...
var G__16259 = x;
var G__16260 = level;
return (reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2 ? reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2(G__16259,G__16260) : reagent.impl.template.expand_seq.call(null,G__16259,G__16260));
} else {
var s = reagent.ratom.capture_derefed((function (){
var G__16261 = x;
var G__16262 = level;
return (reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2 ? reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2(G__16261,G__16262) : reagent.impl.template.expand_seq.call(null,G__16261,G__16262));
}),reagent.impl.template.seq_ctx);
...
var n__4517__auto___16263 = a.length;
var i_16264 = (0);
while(true){
if((i_16264 < n__4517__auto___16263)){
(a[i_16264] = reagent.impl.template.as_component.cljs$core$IFn$_invoke$arity$2((a[i_16264]),level_SINGLEQUOTE_));
