...
reagent.impl.batching.fake_raf = (function fake_raf(f){var G__15274 = f;var G__15275 = (16);return setTimeout(G__15274,G__15275);
});
reagent.impl.batching.next_tick = ((cljs.core.not(reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__3640__auto__ = (w["requestAnimationFrame"]);if(cljs.core.truth_(or__3640__auto__))
...
{var c_15276 = (a[i]);if(cljs.core.truth_((c_15276["cljsIsDirty"])))
{(c_15276["forceUpdate"])();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write(writer__4218__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__15278 = ((function (this$){
return (function (){return this$.run_queue();
});})(this$))
;return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__15278) : reagent.impl.batching.next_tick.call(null,G__15278));
}
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(c){var G__15280 = c;var G__15280__$1 = (((G__15280 == null))?null:(G__15280["props"]));var G__15280__$2 = (((G__15280__$1 == null))?null:(G__15280__$1["argv"]));return G__15280__$2;
});
...
{} else
{throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(new cljs.core.Symbol(null,"is-reagent-component","is-reagent-component",-1856228005,null),new cljs.core.Symbol(null,"c","c",-122660552,null))], 0))))));
}
...
reagent.impl.batching.dispose = (function dispose(c){var G__15282_15283 = (c["cljsRatom"]);var G__15282_15284__$1 = (((G__15282_15283 == null))?null:reagent.ratom.dispose_BANG_(G__15282_15283));return reagent.impl.batching.mark_rendered(c);
});
