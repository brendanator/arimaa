...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15727_SHARP_){
var vec__15729 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(p1__15727_SHARP_,/=/,(2));
...
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__15726_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__15726_SHARP_,"--END--");
...
var vec__15734 = cljs.core.split_at((1),items);
var move = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15734,(0),null);
var steps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15734,(1),null);
...
var animal = (function (){var G__15736 = piece_string.toUpperCase();
switch (G__15736) {
case "R":
...
return (function iter__15749(s__15750){
return (new cljs.core.LazySeq(null,((function (piece_string){
return (function (){
var s__15750__$1 = s__15750;
while(true){
var temp__4126__auto__ = cljs.core.seq(s__15750__$1);
if(temp__4126__auto__){
var xs__4624__auto__ = temp__4126__auto__;
var row = cljs.core.first(xs__4624__auto__);
var iterys__4382__auto__ = ((function (s__15750__$1,row,xs__4624__auto__,temp__4126__auto__,piece_string){
return (function iter__15751(s__15752){
return (new cljs.core.LazySeq(null,((function (s__15750__$1,row,xs__4624__auto__,temp__4126__auto__,piece_string){
return (function (){
var s__15752__$1 = s__15752;
while(true){
var temp__4126__auto____$1 = cljs.core.seq(s__15752__$1);
if(temp__4126__auto____$1){
var s__15752__$2 = temp__4126__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__15752__$2)){
var c__4384__auto__ = cljs.core.chunk_first(s__15752__$2);
var size__4385__auto__ = cljs.core.count(c__4384__auto__);
var b__15754 = cljs.core.chunk_buffer(size__4385__auto__);
if((function (){var i__15753 = (0);
while(true){
if((i__15753 < size__4385__auto__)){
var col = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4384__auto__,i__15753);
cljs.core.chunk_append(b__15754,arimaa.requests.parse_piece(piece_string,row,col));

var G__15760 = (i__15753 + (1));
i__15753 = G__15760;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__15754),iter__15751(cljs.core.chunk_rest(s__15752__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__15754),null);
}
} else {
var col = cljs.core.first(s__15752__$2);
return cljs.core.cons(arimaa.requests.parse_piece(piece_string,row,col),iter__15751(cljs.core.rest(s__15752__$2)));
}
} else {
return null;
}
...
});})(s__15750__$1,row,xs__4624__auto__,temp__4126__auto__,piece_string))
,null,null));
});})(s__15750__$1,row,xs__4624__auto__,temp__4126__auto__,piece_string))
;
var fs__4383__auto__ = cljs.core.seq(iterys__4382__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$2((1),(9))));
if(fs__4383__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4383__auto__,iter__15749(cljs.core.rest(s__15750__$1)));
} else {
var G__15761 = cljs.core.rest(s__15750__$1);
s__15750__$1 = G__15761;
continue;
}
} else {
return null;
...
arimaa.requests.game_state = (function game_state(gameserver_url,gameserver_session_id){
return cljs.core.async.map_LT_(arimaa.requests.parse_game_state,cljs_http.client.post.cljs$core$IFn$_invoke$arity$variadic(gameserver_url,cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$77,false,cljs.core.constant$keyword$98,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$199,"gamestate",cljs.core.constant$keyword$200,gameserver_session_id,cljs.core.constant$keyword$221,(0)], null)], null)], 0)));
});
arimaa.requests.gameroom_state = (function gameroom_state(session_id){
return cljs.core.async.map_LT_((function (response){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic((function (){var G__15763 = cljs.core.constant$keyword$78.cljs$core$IFn$_invoke$arity$1(response);
return JSON.parse(G__15763);
...
var chat = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$222,timestamp,cljs.core.constant$keyword$223,player_name,cljs.core.constant$keyword$224,chat_type], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(chat_type,cljs.core.constant$keyword$225)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([chat,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$226,[cljs.core.str("#"),cljs.core.str(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(chat_line,(3)))].join(''),cljs.core.constant$keyword$142,cljs.core.nth.cljs$core$IFn$_invoke$arity$2(chat_line,(4))], null)], 0));
} else {
return chat;
}
});
arimaa.requests.parse_chat = (function parse_chat(response){
var response_lines = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15764_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$3(p1__15764_SHARP_,/\t/,(5));
}),clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$78.cljs$core$IFn$_invoke$arity$1(response),/\n/));
var header = cljs.core.first(cljs.core.first(response_lines));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(header,"OK")){
return new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$227,cljs.core.first(cljs.core.second(response_lines)),cljs.core.constant$keyword$228,cljs.core.map.cljs$core$IFn$_invoke$arity$2(arimaa.requests.parse_chat_line,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),response_lines))], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(header,"Nothing new")){
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$228,cljs.core.PersistentVector.EMPTY], null);
} else {
if(cljs.core.truth_(header)){
var G__15766 = [cljs.core.str("Unhandled header"),cljs.core.str(response)].join('');
return alert(G__15766);
} else {
return null;
}
}
