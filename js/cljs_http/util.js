...
var vec__23945 = ((cljs.core.map_QMARK_(credentials))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$63,cljs.core.constant$keyword$55], null)):credentials);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23945,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23945,(1),null);
...
*/
cljs_http.util.build_url = (function build_url(p__23946){
var map__23949 = p__23946;
var map__23949__$1 = ((cljs.core.seq_QMARK_(map__23949))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23949):map__23949);
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23949__$1,cljs.core.constant$keyword$61);
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23949__$1,cljs.core.constant$keyword$59);
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23949__$1,cljs.core.constant$keyword$58);
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23949__$1,cljs.core.constant$keyword$57);
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23949__$1,cljs.core.constant$keyword$54);
return [cljs.core.str((function (){var G__23950 = (new goog.Uri());
G__23950.setScheme(cljs.core.name((function (){var or__3750__auto__ = scheme;
...
G__23950.setDomain(server_name);

G__23950.setPort(server_port);

G__23950.setPath(uri);

G__23950.setQuery(query_string,true);
...
var temp__4124__auto__ = ((cljs.core.not(clojure.string.blank_QMARK_(s)))?(function (){var G__23952 = s;
return JSON.parse(G__23952);
})():null);
...
var G__23954 = cljs.core.clj__GT_js(x);
return JSON.stringify(G__23954);
});
cljs_http.util.parse_headers = (function parse_headers(headers){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__23956_SHARP_,p2__23955_SHARP_){
var vec__23958 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__23955_SHARP_,/:\s+/);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__23956_SHARP_,clojure.string.lower_case(k),v);
}
