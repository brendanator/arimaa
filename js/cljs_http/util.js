...
var vec__23420 = ((cljs.core.map_QMARK_(credentials))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$59,cljs.core.constant$keyword$51], null)):credentials);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23420,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23420,(1),null);
...
*/
cljs_http.util.build_url = (function build_url(p__23421){
var map__23424 = p__23421;
...
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23424__$1,cljs.core.constant$keyword$57);
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23424__$1,cljs.core.constant$keyword$55);
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23424__$1,cljs.core.constant$keyword$54);
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23424__$1,cljs.core.constant$keyword$53);
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23424__$1,cljs.core.constant$keyword$50);
return [cljs.core.str((function (){var G__23425 = (new goog.Uri());
G__23425.setScheme(cljs.core.name((function (){var or__3630__auto__ = scheme;
...
G__23425.setDomain(server_name);

G__23425.setPort(server_port);

G__23425.setPath(uri);

G__23425.setQuery(query_string,true);
...
var temp__4124__auto__ = ((cljs.core.not(clojure.string.blank_QMARK_(s)))?(function (){var G__23427 = s;
return JSON.parse(G__23427);
})():null);
...
var G__23429 = cljs.core.clj__GT_js(x);
return JSON.stringify(G__23429);
});
cljs_http.util.parse_headers = (function parse_headers(headers){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__23431_SHARP_,p2__23430_SHARP_){
var vec__23433 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__23430_SHARP_,/:\s+/);
...
return p1__23431_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__23431_SHARP_,clojure.string.lower_case(k),v);
}
