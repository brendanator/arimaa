...
return (function() { 
var G__17275__delegate = function (args){
...
while (G__17276__i < G__17276__a.length) {G__17276__a[G__17276__i] = arguments[G__17276__i + 0]; ++G__17276__i;}
  args = new cljs.core.IndexedSeq(G__17276__a,0);
} 
return G__17275__delegate.call(this,args);};
...
return G__17275__delegate(args);
});
...
var or__3750__auto__ = (function (){var G__17281 = n;
return (reagent.impl.template.attr_aliases.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.attr_aliases.cljs$core$IFn$_invoke$arity$1(G__17281) : reagent.impl.template.attr_aliases.call(null,G__17281));
})();
...
var G__17284 = o;
(G__17284[(function (){var G__17285 = k;
return (reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1(G__17285) : reagent.impl.template.cached_prop_name.call(null,G__17285));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__17286){
var vec__17288 = p__17286;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17288,(0),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17288,(1),null);
var pid = (props["id"]);
...
var pname_17291 = (function (){var G__17290 = k;
return (reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1(G__17290) : reagent.impl.template.cached_prop_name.call(null,G__17290));
})();
if(!((pname_17291 === "key"))){
(o[pname_17291] = reagent.impl.template.convert_prop_value(v));
} else {
}
...
var res = (function (){var G__17293 = e;
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__17293) : on_change.call(null,G__17293));
})();
...
(G__17296["defaultValue"] = value);

(G__17296["value"] = null);

(G__17296["onChange"] = ((function (G__17296,on_change,value){
return (function (p1__17294_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__17294_SHARP_);
});})(G__17296,on_change,value))
);
...
var jsargs = (function (){var G__17302 = argv;
var G__17303 = ((hasprops)?(2):(1));
var G__17304 = ((inprops["level"]) + (1));
return (reagent.impl.template.convert_args.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.convert_args.cljs$core$IFn$_invoke$arity$3(G__17302,G__17303,G__17304) : reagent.impl.template.convert_args.call(null,G__17302,G__17303,G__17304));
})();
var jsprops = reagent.impl.template.convert_props(((hasprops)?props:null),id_class);
if((input_setup == null)){
} else {
var G__17305_17307 = this$;
var G__17306_17308 = jsprops;
(input_setup.cljs$core$IFn$_invoke$arity$2 ? input_setup.cljs$core$IFn$_invoke$arity$2(G__17305_17307,G__17306_17308) : input_setup.call(null,G__17305_17307,G__17306_17308));
}
...
var G__17310 = spec;
(G__17310["componentDidUpdate"] = ((function (G__17310){
return (function (){
var c = this;
...
(G__17310["componentWillUnmount"] = ((function (G__17310){
return (function (){
var c = this;
...
var C = this;
return reagent.impl.template.wrapped_should_update(C,p1__17311_SHARP_,p2__17312_SHARP_);
...
var vec__17314 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17314,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17314,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17314,(2),null);
...
var vec__17316 = reagent.impl.template.parse_tag(tag);
var comp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17316,(0),null);
var id_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17316,(1),null);
...
var res = (function (){var G__17318 = withrender;
return (reagent.impl.template.create_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.create_class.cljs$core$IFn$_invoke$arity$1(G__17318) : reagent.impl.template.create_class.call(null,G__17318));
})();
...
var G__17320 = tag;
return (reagent.impl.template.cached_wrapper.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_wrapper.cljs$core$IFn$_invoke$arity$1(G__17320) : reagent.impl.template.cached_wrapper.call(null,G__17320));
} else {
...
var k_17323 = reagent.impl.template.get_key(cljs.core.meta(v));
var k_SINGLEQUOTE__17324 = (((k_17323 == null))?reagent.impl.template.get_key(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(1),null)):k_17323);
if((k_SINGLEQUOTE__17324 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__17324);
}

var G__17322 = jsprops;
return (c.cljs$core$IFn$_invoke$arity$1 ? c.cljs$core$IFn$_invoke$arity$1(G__17322) : c.call(null,G__17322));
});
...
var G__17331 = x;
var G__17332 = level;
return (reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2 ? reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2(G__17331,G__17332) : reagent.impl.template.expand_seq.call(null,G__17331,G__17332));
} else {
var s = reagent.ratom.capture_derefed((function (){
var G__17333 = x;
var G__17334 = level;
return (reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2 ? reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2(G__17333,G__17334) : reagent.impl.template.expand_seq.call(null,G__17333,G__17334));
}),reagent.impl.template.seq_ctx);
...
var n__4637__auto___17335 = a.length;
var i_17336 = (0);
while(true){
if((i_17336 < n__4637__auto___17335)){
(a[i_17336] = reagent.impl.template.as_component.cljs$core$IFn$_invoke$arity$2((a[i_17336]),level_SINGLEQUOTE_));

var G__17337 = (i_17336 + (1));
i_17336 = G__17337;
continue;
} else {
}
