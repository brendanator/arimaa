...
var or__3630__auto__ = (function (){var G__16330 = n;
return (reagent.impl.template.attr_aliases.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.attr_aliases.cljs$core$IFn$_invoke$arity$1(G__16330) : reagent.impl.template.attr_aliases.call(null,G__16330));
})();
...
var G__16333 = o;
(G__16333[(function (){var G__16334 = k;
return (reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1(G__16334) : reagent.impl.template.cached_prop_name.call(null,G__16334));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__16335){
var vec__16337 = p__16335;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16337,(0),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16337,(1),null);
var pid = (props["id"]);
...
var pname_16340 = (function (){var G__16339 = k;
return (reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1(G__16339) : reagent.impl.template.cached_prop_name.call(null,G__16339));
})();
if(!((pname_16340 === "key"))){
(o[pname_16340] = reagent.impl.template.convert_prop_value(v));
} else {
}
...
var res = (function (){var G__16342 = e;
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__16342) : on_change.call(null,G__16342));
})();
...
var G__16345 = jsprops;
(G__16345["defaultValue"] = value);

(G__16345["value"] = null);

(G__16345["onChange"] = ((function (G__16345,on_change,value){
return (function (p1__16343_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__16343_SHARP_);
});})(G__16345,on_change,value))
);
...
var jsargs = (function (){var G__16351 = argv;
var G__16352 = ((hasprops)?(2):(1));
var G__16353 = ((inprops["level"]) + (1));
return (reagent.impl.template.convert_args.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.convert_args.cljs$core$IFn$_invoke$arity$3(G__16351,G__16352,G__16353) : reagent.impl.template.convert_args.call(null,G__16351,G__16352,G__16353));
})();
var jsprops = reagent.impl.template.convert_props(((hasprops)?props:null),id_class);
if((input_setup == null)){
} else {
var G__16354_16356 = this$;
var G__16355_16357 = jsprops;
(input_setup.cljs$core$IFn$_invoke$arity$2 ? input_setup.cljs$core$IFn$_invoke$arity$2(G__16354_16356,G__16355_16357) : input_setup.call(null,G__16354_16356,G__16355_16357));
}
...
var G__16359 = spec;
(G__16359["componentDidUpdate"] = ((function (G__16359){
return (function (){
var c = this;
...
(G__16359["componentWillUnmount"] = ((function (G__16359){
return (function (){
var c = this;
...
return (function (p1__16360_SHARP_,p2__16361_SHARP_){
var C = this;
return reagent.impl.template.wrapped_should_update(C,p1__16360_SHARP_,p2__16361_SHARP_);
...
var vec__16363 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16363,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16363,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16363,(2),null);
...
var vec__16365 = reagent.impl.template.parse_tag(tag);
var comp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16365,(0),null);
var id_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16365,(1),null);
...
var res = (function (){var G__16367 = withrender;
return (reagent.impl.template.create_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.create_class.cljs$core$IFn$_invoke$arity$1(G__16367) : reagent.impl.template.create_class.call(null,G__16367));
})();
...
var G__16369 = tag;
return (reagent.impl.template.cached_wrapper.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_wrapper.cljs$core$IFn$_invoke$arity$1(G__16369) : reagent.impl.template.cached_wrapper.call(null,G__16369));
} else {
...
var k_16372 = reagent.impl.template.get_key(cljs.core.meta(v));
var k_SINGLEQUOTE__16373 = (((k_16372 == null))?reagent.impl.template.get_key(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(1),null)):k_16372);
if((k_SINGLEQUOTE__16373 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__16373);
}

var G__16371 = jsprops;
return (c.cljs$core$IFn$_invoke$arity$1 ? c.cljs$core$IFn$_invoke$arity$1(G__16371) : c.call(null,G__16371));
});
...
var G__16380 = x;
var G__16381 = level;
return (reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2 ? reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2(G__16380,G__16381) : reagent.impl.template.expand_seq.call(null,G__16380,G__16381));
} else {
...
var n__4517__auto___16384 = a.length;
var i_16385 = (0);
while(true){
if((i_16385 < n__4517__auto___16384)){
(a[i_16385] = reagent.impl.template.as_component.cljs$core$IFn$_invoke$arity$2((a[i_16385]),level_SINGLEQUOTE_));
